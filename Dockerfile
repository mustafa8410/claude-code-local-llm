# claude-code-local-llm - one image, built from this one file.
#
...
LABEL org.opencontainers.image.title="claude-code-local-llm" \
      org.opencontainers.image.description="Anthropic-compatible gateway that runs local GGUF models behind Claude Code" \
      org.opencontainers.image.source="https://github.com/mustafa8410/claude-code-local-llm" \
      org.opencontainers.image.url="https://github.com/mustafa8410/claude-code-local-llm" \
      org.opencontainers.image.documentation="https://github.com/mustafa8410/claude-code-local-llm#readme" \
