...
<h2>Endpoints</h2>
<table><thead><tr><th>route</th><th>purpose</th></tr></thead><tbody>
<tr><td class="n">POST /v1/messages</td><td>inference, streaming or not</td></tr>
<tr><td class="n">POST /v1/messages/count_tokens</td><td>token counting without loading a model</td></tr>
<tr><td class="n">GET /v1/models</td><td>discovery; fills Claude Code's <code>/model</code> picker</td></tr>
<tr><td class="n">GET /health</td><td>state, backend status, recent backend logs</td></tr>
<tr><td class="n">GET /admin/models</td><td>catalog with capabilities and availability</td></tr>
<tr><td class="n">POST /admin/models</td><td>add a model at runtime</td></tr>
<tr><td class="n">POST /admin/models/pull</td><td>download weights, streaming progress</td></tr>
<tr><td class="n">GET /admin/client-env</td><td>this configuration, as <code>sh</code>, <code>ps1</code> or JSON</td></tr>
<tr><td class="n">GET /admin/reasoning</td><td>thinking budget per model, and its allowed range</td></tr>
<tr><td class="n">GET /admin/config</td><td>every setting and example, as JSON</td></tr>
</tbody></table>
